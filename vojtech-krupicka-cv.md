...
- Processed global digital elevation models (DEMs, 200GB+ source data), wrote scripts for generating better looking hillshades and smoothed contours lines
...
- Solo developer and maintainer of the Mapy.com end-user bug tracking system using external MantisBT as a bug tracker — built new plugins (PHP Full-stack), and components (Python, PostgreSQL) connecting frontends with MantisBT for the entire Mapy.com issue-reporting system — connecting the helpdesk to end-user feedback loops with a Mantis BT 1.3 → 2.x migration and MySQL → PostgreSQL migration (2014 – 2026)
...
- Built a job, which repeatedly checked, validated and updated thounsands of stored web URLs to external web pages (2018)
